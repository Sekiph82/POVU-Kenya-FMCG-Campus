# M01_VIDEO-003_V01_GPT_PROMPT

## Video
003 — People & Employee Campus
...
coordination/Logs/M01_VIDEO-003_V01_CODEX_LOG.md

GitHub URL:
https://github.com/Sekiph82/POVU-Kenya-FMCG-Campus/blob/main/coordination/Logs/M01_VIDEO-003_V01_CODEX_LOG.md

## Required later GPT audit
Codex must NOT author the audit. GPT will later create:
coordination/Audits/M01_VIDEO-003_V01_GPT_AUDIT.md

## Deliverable
Render one production MP4 for **People & Employee Campus** using the reusable local Blender pipeline.

Filename prefix:
POVU_VID_003_People_Employee_Campus

Temporary production camera:
VID_003_People_Employee_Campus

## Cinematic intent
Create a clear, polished factory-tour film centered specifically on **People & Employee Campus**.
