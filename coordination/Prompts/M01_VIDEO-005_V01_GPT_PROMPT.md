# M01_VIDEO-005_V01_GPT_PROMPT

## Video
005 — R&D + QC Innovation Centre
...
coordination/Logs/M01_VIDEO-005_V01_CODEX_LOG.md

GitHub URL:
https://github.com/Sekiph82/POVU-Kenya-FMCG-Campus/blob/main/coordination/Logs/M01_VIDEO-005_V01_CODEX_LOG.md

## Required later GPT audit
Codex must NOT author the audit. GPT will later create:
coordination/Audits/M01_VIDEO-005_V01_GPT_AUDIT.md

## Deliverable
Render one production MP4 for **R&D + QC Innovation Centre** using the reusable local Blender pipeline.

Filename prefix:
POVU_VID_005_R_D_QC_Innovation_Centre

Temporary production camera:
VID_005_R_D_QC_Innovation_Centre

## Cinematic intent
Create a clear, polished factory-tour film centered specifically on **R&D + QC Innovation Centre**.
