# M01_VIDEO-006_V01_GPT_PROMPT

## Video
006 — Training & POVU Academy
...
coordination/Logs/M01_VIDEO-006_V01_CODEX_LOG.md

GitHub URL:
https://github.com/Sekiph82/POVU-Kenya-FMCG-Campus/blob/main/coordination/Logs/M01_VIDEO-006_V01_CODEX_LOG.md

## Required later GPT audit
Codex must NOT author the audit. GPT will later create:
coordination/Audits/M01_VIDEO-006_V01_GPT_AUDIT.md

## Deliverable
Render one production MP4 for **Training & POVU Academy** using the reusable local Blender pipeline.

Filename prefix:
POVU_VID_006_Training_POVU_Academy

Temporary production camera:
VID_006_Training_POVU_Academy

## Cinematic intent
Create a clear, polished factory-tour film centered specifically on **Training & POVU Academy**.
