# M01_VIDEO-007_V01_GPT_PROMPT

## Video
007 — Restaurant + POVU Café
...
coordination/Logs/M01_VIDEO-007_V01_CODEX_LOG.md

GitHub URL:
https://github.com/Sekiph82/POVU-Kenya-FMCG-Campus/blob/main/coordination/Logs/M01_VIDEO-007_V01_CODEX_LOG.md

## Required later GPT audit
Codex must NOT author the audit. GPT will later create:
coordination/Audits/M01_VIDEO-007_V01_GPT_AUDIT.md

## Deliverable
Render one production MP4 for **Restaurant + POVU Café** using the reusable local Blender pipeline.

Filename prefix:
POVU_VID_007_Restaurant_POVU_Caf

Temporary production camera:
VID_007_Restaurant_POVU_Caf

## Cinematic intent
Create a clear, polished factory-tour film centered specifically on **Restaurant + POVU Café**.
