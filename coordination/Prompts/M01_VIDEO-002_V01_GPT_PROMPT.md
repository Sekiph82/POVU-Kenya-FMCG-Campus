# M01_VIDEO-002_V01_GPT_PROMPT

## Video
002 — Main Entrance & POVU Plaza
...
coordination/Logs/M01_VIDEO-002_V01_CODEX_LOG.md

GitHub URL:
https://github.com/Sekiph82/POVU-Kenya-FMCG-Campus/blob/main/coordination/Logs/M01_VIDEO-002_V01_CODEX_LOG.md

## Required later GPT audit
Codex must NOT author the audit. GPT will later create:
coordination/Audits/M01_VIDEO-002_V01_GPT_AUDIT.md

## Deliverable
Render one production MP4 for **Main Entrance & POVU Plaza** using the reusable local Blender pipeline.

Filename prefix:
POVU_VID_002_Main_Entrance_POVU_Plaza

Temporary production camera:
VID_002_Main_Entrance_POVU_Plaza

## Cinematic intent
Create a clear, polished factory-tour film centered specifically on **Main Entrance & POVU Plaza**.
