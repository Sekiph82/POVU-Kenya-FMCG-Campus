...
## Deliverable
Render one production MP4 for **POVU Campus Aerial** using the reusable local Blender pipeline.

Filename prefix:
POVU_VID_001_POVU_Campus_Aerial

Temporary production camera:
VID_001_POVU_Campus_Aerial

## Cinematic intent
Create a clear, polished factory-tour film centered specifically on **POVU Campus Aerial**.
