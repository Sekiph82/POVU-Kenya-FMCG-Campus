# M01_VIDEO-009_V01_GPT_PROMPT

## Video
009 — Daycare & Family Facilities
...
coordination/Logs/M01_VIDEO-009_V01_CODEX_LOG.md

GitHub URL:
https://github.com/Sekiph82/POVU-Kenya-FMCG-Campus/blob/main/coordination/Logs/M01_VIDEO-009_V01_CODEX_LOG.md

## Required later GPT audit
Codex must NOT author the audit. GPT will later create:
coordination/Audits/M01_VIDEO-009_V01_GPT_AUDIT.md

## Deliverable
Render one production MP4 for **Daycare & Family Facilities** using the reusable local Blender pipeline.

Filename prefix:
POVU_VID_009_Daycare_Family_Facilities

Temporary production camera:
VID_009_Daycare_Family_Facilities

## Cinematic intent
Create a clear, polished factory-tour film centered specifically on **Daycare & Family Facilities**.
